...
export const inputSchema = {
    path: z
        .string()
        .describe("Documentation path from the llms.txt index (e.g., '/docs/app/api-reference/functions/refresh'). You MUST get this path from the nextjs-docs://llms-index resource."),
    anchor: z
        .string()
        .optional()
        .describe("Optional anchor/section from the index (e.g., 'usage'). Included in response metadata to indicate relevant section."),
};
...
export async function handler({ path, anchor }) {
