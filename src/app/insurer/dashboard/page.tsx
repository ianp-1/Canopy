      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 h-[600px]">
         ...
         <Card className="lg:col-span-2 border-none shadow-sm bg-white overflow-hidden flex flex-col">
            ...
            <div className="flex-1 bg-slate-50 relative group cursor-crosshair">
               ...
               {/* Map Markers */}
               <MapMarker top="30%" left="25%" size="lg" label="Iowa Cluster" />
               <MapMarker top="60%" left="65%" size="md" label="Brazil Soy" />
               <MapMarker top="35%" left="75%" size="sm" color="bg-red-500" label="Drought Alert" />
...
function KPICard({ label, value, subValue, icon: Icon, trend, alert }: any) {
   return (
...
function MapMarker({ top, left, size, color = "bg-[#2E7D32]", label }: any) {
...
function ActivityItem({ action, target, time, type = "normal" }: any) {
   return (
